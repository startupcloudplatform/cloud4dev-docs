...
1. 개별주택WFS조회
   ...
   ![opendata_api_address](C:/Users/crosshan/Dropbox (크로경영)/클라우드 플랫폼 연구소/00.(진행중)2020년 클라우드기반 개발지원 플랫폼 운영사업/04.활용지원/02.활용가이드/01.오픈데이터마켓 활용가이드/myopenapi.png)

   ​	- 개별주택가격WFS조회 속성 정보

   WFS(Web Feature Service) 서비스는 (벡터 도형 및 속성을 지닌)지리 피처 데이터를 활용할 수 있도록 합니다.

   ​	- 호출 시 아래 그림과 같이 항목명칭, 데이터타입을 맞춰서 데이터를 가져옵니다.![opendata_api_address](C:/Users/crosshan/Dropbox (크로경영)/클라우드 플랫폼 연구소/00.(진행중)2020년 클라우드기반 개발지원 플랫폼 운영사업/04.활용지원/02.활용가이드/01.오픈데이터마켓 활용가이드/housepricewfs.png)
